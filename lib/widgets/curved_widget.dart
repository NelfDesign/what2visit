...
class CurvedWidget extends StatelessWidget {
  ...
  const CurvedWidget(
      {Key? key, this.curvedDistance = 200, this.curvedHeight = 80, this.child})
      : super(key: key);
...
class CurvedWidgetBackgroundClipper extends CustomClipper<Path> {
  final num? curvedDistance;
  final num? curvedHeight;
  ...
  getClip(Size size) {
    ...
    clippedPath.lineTo(curvedDistance!.toDouble(), size.height - curvedHeight!);
